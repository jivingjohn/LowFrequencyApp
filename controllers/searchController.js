  ...
  (req, res, next) => {
    ...
    return;
      ...
      client.get('',function(err, result, body) {
        ...
        var title = 'Word frequency within the Wikipedia entry for:',
        ...
        // Get all the words from our sentences

        res.render('matches', { 'title': title, 'subtitle': subtitle, 'results': WordCount.MatchWords(sentences) });
      });
    }
  }
];
